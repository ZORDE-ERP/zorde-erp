...
import type { Autenticacao } from '@prisma/client';
...
const AutenticacaoMapper = {
	toDomain(raw: Autenticacao): AutenticacaoEntity {
	...
	toPersistence(entity: AutenticacaoEntity): {
		idUsuario: number;
...
export class PrismaAutenticacaoRepository implements IAutenticacaoRepository {
	...
	public async atualizarStatus(id: number, status: StatusSessao): Promise<void> {
